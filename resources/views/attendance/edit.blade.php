...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="row">
            ...
            <form action = "{{ route('attendance.mass_update') }}" method="POST" id="save_attendance_form">
                                        ...
                                        @foreach($employees as $employee)
                                            ...
                                            <tr>
                                                ...
                                                @for($date_cnt = 0;  $date_cnt <= $days_diff_cnt; $date_cnt++)
                                                    ...
                                                    <td>
                                                        <input type="time" name="time_in[{{ $attendance_index }}]" value="@if(isset($attendance_arr[$cur_date][$employee->id])){{$attendance_arr[$cur_date][$employee->id]['time_in']}}@endif"> 
...
<!--                                                     
                                                    ...
                                                    <td>
                                                        <input type="time" name="time_out[{{ $attendance_index }}]" value="@if(isset($attendance_arr[$cur_date][$employee->id])){{$attendance_arr[$cur_date][$employee->id]['time_out']}}@endif">
                        ...
                        <div class="mt-4">
                            ...
                            <button type="button" class="btn btn-info">Generate Payroll <i class="fa fa-money"></i></button>
                        </div>
