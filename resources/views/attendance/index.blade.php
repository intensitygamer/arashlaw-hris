                            ...
                            <div class="col col-4">
                                <table class="table">
                                    ...
                                    <tr><td><b> Department </b> </td>  
                                        <td>
                                            {!! department_field(array( 'name'=>'department_id', 'class' => 'form-control')) !!}
                    ...
                    <div class="row">
                        <div class="col col-2">
                            ...
                            <div class="employee-list-table-container">
                                ...
                                <table class="table mt-4 text-center" id="employee-list-table">
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                            ...
                                            <tr>
                                                ...
                                                @for($date_cnt = 0;  $date_cnt <= $days_diff_cnt; $date_cnt++)
                                                    ...
                                                    <td>                                                        
                                                        ...
                                                        @if(isset($attendance_arr[$cur_date][$employee->id]['time_in']))
                                                            {{ time_formatter($attendance_arr[$cur_date][$employee->id]['time_in']) }}
                                                        @endif
                                                    ...
                                                    <td>
                                                        @if(isset($attendance_arr[$cur_date][$employee->id]['time_out']))
                                                            {{ time_formatter($attendance_arr[$cur_date][$employee->id]['time_out']) }}
                                                        @endif
                        ...
                        <div class="mt-4">
                            ...
                            <form action= "{{ route('attendance.edit') }}" method="GET">

                                @csrf 

                                 <button type="submit" class="btn btn-success"> Edit <i class="fa fa-edit"></i></button>
                                    
                                <input type="hidden" class="form-control" name="from_date" value="{{$from_date}}"/> 
                                <input type="hidden" class="form-control" name="to_date" value="{{$to_date}}"/> 
