...
<div class="modal fade " id='addEmployeesModal' tabindex="-1">
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <form action = "{{ route('employee.create') }}" method="POST" id="save_employee_form">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <label for="job_title_field" class="form-label"> Department </label>
                    ...
                    <div class="col col-md-4 col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <label for="" class="form-label" >Required Hours Per Payroll</label>
                                
                                <input type='text' name="required_hours_per_payroll" id="" value="96"  class="form-control" />
                            ...
                            <div class="mb-2 mt-4">
                                ...
                                <h4>Payroll Fix Amount Headers</h4>
